    ...
    return (
        <div className="auth-page">
            <div className="h-screen flex justify-center items-center">
                <div className="hidden md:block lg:w-1/3 bg-white h-full auth-background-register rounded-tr-lg rounded-br-lg"></div>
                    ...
                    <div className="w-full lg:w-1/2 px-10 lg:px-0">
                        ...
                        <div className="text-center">
                            <p className="text-white text-md">
                                Already have an account? <Link to="/sign-in" className="no-underline text-orange-button">Sign In</Link>.
                            </p>
                        </div>
                    </div>
                </div>
